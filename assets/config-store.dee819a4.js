import { h as btnDesignOptions, i as btnPadding, j as getBtnDesign, Q as QBtn } from "./QBtn.a17df556.js";
...
import { b as between } from "./QSelect.ad12804a.js";
import { c as computed, r as ref, w as watch, h, g as getCurrentInstance, O as isKeyCode, A as useAuthStore, a2 as defineStore } from "./index.cf036711.js";
...
const _key = (key) => `${user.id}_${key}`;
const useConfigStore = defineStore("config", {
  state: () => ({
    cartGrid: JSON.parse(window.localStorage.getItem(_key("cartGrid")))
  }),
  getters: {
    size(state) {
  ...
  actions: {
    commit(key) {
      window.localStorage.setItem(_key(key), JSON.stringify(this[key]));
    },
    has(key) {
...
export { QPagination as Q, useConfigStore as u };
